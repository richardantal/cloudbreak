...
public class UserSyncService {
    ...
    public Operation synchronizeUsers(String accountId, String actorCrn, Set<String> environmentCrnFilter,
            Set<String> userCrnFilter, Set<String> machineUserCrnFilter, boolean forceWorkloadCredentialsUpdate) {
        ...
        UserSyncOptions options = getUserSyncOptions(accountId, userSyncFilter.isFullSync(), forceWorkloadCredentialsUpdate);
    ...
    public Operation synchronizeUsersWithCustomPermissionCheck(String accountId, String actorCrn, Set<String> environmentCrnFilter,
            UserSyncRequestFilter userSyncFilter, boolean forceWorkloadCredentialsUpdate, AuthorizationResourceAction action) {
        List<Stack> stacks = getStacksForSync(accountId, actorCrn, environmentCrnFilter, userSyncFilter);
    ...
    private UserSyncOptions getUserSyncOptions(String accountId, boolean fullSync, boolean forceWorkloadCredentialsUpdate) {
        boolean credentialsUpdateOptimizationEnabled = !forceWorkloadCredentialsUpdate &&
                entitlementService.usersyncCredentialsUpdateOptimizationEnabled(accountId);
        LOGGER.info("Credentials update optimization is{} enabled for this sync request", credentialsUpdateOptimizationEnabled ? "" : " not");
        return new UserSyncOptions(fullSync, entitlementService.isFmsToFreeipaBatchCallEnabled(accountId), credentialsUpdateOptimizationEnabled);
    }
